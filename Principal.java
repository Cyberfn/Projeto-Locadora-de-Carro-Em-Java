				...
				do {
					...
					case 2:
						...
						try {
							...
							novaLocacao.setData_locacao(new java.sql.Date(dataInicio.getTime()));
							novaLocacao.setData_devolucao(new java.sql.Date(dataTermino.getTime()));
						} catch (ParseException e) {
					...
					case 3:
					    ...
					    Long novoIdCarro = scanner.nextLong();
					...
					case 4:
						...
						int id_Carro = scanner.nextInt();
						scanner.nextLine(); // Consumir a quebra de linha pendente

						LocacaoCRUD.excluirLocacao(id_Cliente, id_Carro);
						break;
